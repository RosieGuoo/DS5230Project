...
df <- read_csv("/Users/rosie/Desktop/twitchdata-update.csv")
...
# do dimensionality reduction: FAMD
famd_result <- FAMD(df_new, graph = FALSE)

# summarize the reslt, we can see the variance explained by each component
summary(famd_result)

# show the Eigenvalues and Scree Plot
